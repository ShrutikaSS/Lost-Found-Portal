<?php
// TrackNFind PHP Database Configuration (PDO SQLite)

$db_file = __DIR__ . '/../database.sqlite';
$is_new_db = !file_exists($db_file) || filesize($db_file) === 0;
...
try {
    ...
    // Auto-create DDL Schema if DB is new or tables don't exist
    $pdo->exec("
    ...
    // Auto Seed baseline categories & demo accounts if users table is empty
    ...
    if ($user_count == 0) {
        ...
        // Baseline Items with high-res photos
